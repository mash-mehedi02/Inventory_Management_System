...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String password = new String(passText.getPassword()); // Fix password retrieval
        ...
        if (new ConnectionFactory().checkLogin(username, password, "ADMINISTRATOR")) {
            ...
            new Dashboard(username, "ADMINISTRATOR").setVisible(true); // Assuming Dashboard is a JFrame
        } else {
            JOptionPane.showMessageDialog(
                    this,
